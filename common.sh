...
#添加
    find . -type d -name 'ddns-go' -o -name 'luci-app-ddns-go' -o -name 'luci-app-v2ray-server' -o -name 'luci-app-netdata' -o -name 'autosamba' -o -name 'luci-app-samba4' -o -name 'luci-app-ikoolproxy' -o -name 'aliyundrive-webdav' | xargs -i rm -rf {}
